...
public class ApplicationAgent {
	...
	private static int creationSuperHero(String nomSuperHero) {
		...
		System.out.println("Entrer la coordonnée X 1l'avez aperéu : ");
		int coordX = scanner.nextInt();
		System.out.println("Entrer é présent la coordonnée Y oé vous l'avez aperéu : ");
		int coordY = scanner.nextInt();
		System.out.println("A quelle date l'avez vous aperéu : ");
		...
		if(idSuperHero < 0){
			System.out.println("L'ajout n'a pas pu étre effectué");
		} else {
	...
	private static void rapportCombat() {
		...
		int idCombat = -1;
		try {
			System.out.println("Nous allons é présent passer é l'encodage des participations");
			int i = 0;
			char boucle;
			do {
	...
	private static void reperage(){
		...
		System.out.println("-------------------------------------------");
		System.out.println("Commencer par entrer le nom du superhéros que vous avez aperéu : ");
		String nomSuperHero = scanner.next();
		int idSuperHero = checkSiPresent(nomSuperHero);
